...
public class GetraenkeBoxScrollPane extends JPanel {
	...
	public GetraenkeBoxScrollPane(Bestellung bestellung, JTextArea area, JTextArea total) throws IOException {
		super();
		...
		try {
			for (Getraenke getraenk : db.getAllGetraenke()) {
				ProductBox getraenkeBox = new ProductBox(bestellung, getraenk.getGetraenk(), getraenk.getPreis(),getraenk.getEmpty() , getraenk.getBild(), area, total);
